...
const KeyAreaItem = ({ level, link }: { level: number; link: string }) => {
  const isCurrentLevel = level === 1; // Kiểm tra nếu là tầng 16
...
export default function ResidentialPage() {
  const levels = [
    { level: 3, link: "/khu-thuong-mai/Level-3" },
    { level: 2, link: "/khu-thuong-mai/Level-2" },
    { level: 1, link: "/khu-thuong-mai/Level-1" },
  ];
